...
################################################################################
## Form generated from reading UI file 'stationOrngEl.ui'
##
...
"}")
        ...
        icon = QIcon("/home/doom/Desktop/projects/stationar/icons/menu2.png")
        ...
        font6 = QFont()
        font6.setFamilies([u"Ubuntu Mono"])
        font6.setStyleStrategy(QFont.PreferDefault)
        self.about_page.setFont(font6)
        ...
        self.add_user_btn.setFont(font7)
